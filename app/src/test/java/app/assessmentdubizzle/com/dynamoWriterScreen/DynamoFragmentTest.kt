...
import app.assessmentdubizzle.com.modules.view.fragments.ListFragment
...
class DynamoFragmentTest : BaseUTTest(){
    ...
    private lateinit var dynamoListFragment: ListFragment
    ...
    fun start(){
        ...
        dynamoListFragment = ListFragment()
