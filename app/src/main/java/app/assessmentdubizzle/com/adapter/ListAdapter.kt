...
class ListAdapter(listener: ItemClickListener, val context: Context?
) : RecyclerView.Adapter<ListAdapter.DynamoListViewHolder>() {
    private var dynamoWriterArrayList: ArrayList<ResultsItem>? = null
    private var mContext: Context? = null

    private var dynamoWriterItemClickListener: ItemClickListener? = null
